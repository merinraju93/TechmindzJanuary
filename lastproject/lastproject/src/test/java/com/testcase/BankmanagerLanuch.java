...
import com.pages.BanklMangerPage;

public class BankmanagerLanuch extends TestBase
{
BanklMangerPage bankManagerPage;

public BankmanagerLanuch()
{
super();
}
@BeforeClass
...
{
initialization();
bankManagerPage=new BanklMangerPage();
}
@Test (priority=1)
...
Assert.assertEquals(pText,"Account created successfully with account Number:1001");
}
@Test (priority=8)
